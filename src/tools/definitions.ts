...
Returns: aggregated top-LPer patterns from the discovery relay
...
Returns owner aggregates and historical style/range samples from
the discovery relay \`/study-top-lp/:pool\` endpoint.
